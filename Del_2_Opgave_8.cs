...
class Opgave8
{
    ...
    public static void Run()
    {
        ...
        foreach (int t in ts)
        {
            ...
            Console.WriteLine($"Time elapsed for 100 experiments: {sw.ElapsedMilliseconds} ms");
            ...
            plt.SavePng($"median_scatterplot{t}.png", 600, 400);
            Console.WriteLine($"Saved to median_scatterplot{t}.png");
            ...
            plt.SavePng($"scatterplot{t}.png", 600, 400);
            Console.WriteLine($"Saved to scatterplot{t}.png");

            Console.WriteLine($"t = {t} - Mean Squared Error: {MeanSquaredError(Xs, s)}");
            double avg = Xs.Average();

            Console.WriteLine($"t = {t}: E[X] = {Xs.Average()}");
            Console.WriteLine($"t = {t}: Var[X] = {Variance(Xs)}");
